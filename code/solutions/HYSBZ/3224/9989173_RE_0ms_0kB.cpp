...
int main(){
    ...
    while(k--){
        ...
        cin>>op>>x;
        if(op==1){
            splay.addNum(splay.root,x);
        }else if(op==2){
            splay.remove(splay.root,x);
        }else if(op==3){
            cout<<splay.getrank(splay.root,x)<<endl;
        }else if(op==4){
            cout<<splay.getxbyrank(splay.root,x)<<endl;
        }else if(op==5){
            cout<<splay.data[splay.getb(splay.root,x)]<<endl;
        }else if(op==6){
            cout<<splay.data[splay.geta(splay.root,x)]<<endl;
        }
    }
}